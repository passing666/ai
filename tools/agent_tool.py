...
async def agent_aggregate_and_greet(query: str, name: str, max_results: int = 3) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"greeting": greet.get("message") if isinstance(greet, dict) else greet, "aggregation": agg}
